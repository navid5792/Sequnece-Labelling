...
def load_embedding_wlm(emb_file, delimiter, feature_map, full_feature_set, caseless, unk, emb_len, shrink_to_train=False, shrink_to_corpus=False):
    ...
    args: 
        ...
        feature_map: word dictionary 118
        full_feature_set: all words in the corpus 1795
    ...
    #print(len(full_feature_set))#1676      1795 to  1676 because of having tolower() version of some words
    ...
    rand_embedding_tensor = torch.FloatTensor(in_doc_freq_num, emb_len) #114 and 100

    init_embedding(rand_embedding_tensor)#114x400
    ...
    #print(len(indoc_embedding_array)) #1489
    #print(len(outdoc_embedding_array)) #398399
    #print(len(indoc_word_array)) #1489
    #print(len(outdoc_word_array)) #398399
    ...
    #print(in_doc_num) #1603 = 1489 + 118
